        ...
        <div className="grid gap-6 items-center lg:grid-cols-2 lg:gap-12">
          <div className="space-y-4 text-center lg:text-left">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed mx-auto lg:mx-0">
              At Lonely Corporation, we are dedicated to developing pioneering technology that grants users unrestricted and secure access to the digital world. We believe in an open internet and build the tools to make it a reality.
            </p>
          </div>
